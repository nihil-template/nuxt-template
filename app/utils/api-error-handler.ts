import type { ResponseType, ResponseCode } from '~/types/common.types';
...
export function checkAndHandleApiError<TData = unknown>(
  response: ResponseType<TData> | undefined,
 ...
 */
export function throwIfError<TData = unknown>(response: ResponseType<TData> | undefined): void {
