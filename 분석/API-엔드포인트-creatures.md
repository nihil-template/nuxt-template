...
### 목록 조회
```
GET /projects/:prjNo/creatures/:creatureNo/skills
Status: 200
```
...
### 상세 조회
```
GET /projects/:prjNo/creatures/:creatureNo/skills/:mapNo
Status: 200
```
...
### 생성
```
POST /projects/:prjNo/creatures/:creatureNo/skills
Status: 200
```
...
### 수정
```
PATCH /projects/:prjNo/creatures/:creatureNo/skills/:mapNo
Status: 200
```
...
### 삭제
```
DELETE /projects/:prjNo/creatures/:creatureNo/skills/:mapNo
Status: 200
```
