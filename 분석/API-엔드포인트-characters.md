...
### 목록 조회
```
GET /projects/:prjNo/characters/:charNo/skills
Status: 200
```
...
- `page_no`: number (optional, default: 1) - 페이지 번호
- `page_size`: number (optional, default: 10) - 페이지당 항목 수
- `skill_type`: string (optional) - 스킬 타입 필터 (GLOBAL, PROJECT)
...
### 상세 조회
```
GET /projects/:prjNo/characters/:charNo/skills/:skillNo
Status: 200
```
...
**Query Parameters:**
- `skill_type`: string (required) - 스킬 타입 (GLOBAL, PROJECT)
...
### 생성
```
POST /projects/:prjNo/characters/:charNo/skills
Status: 200
```
...
```json
{
  "skill_no": "number (required)",
  "skill_type": "string (required)",
  "prof_lvl": "string (optional)",
  "skill_rmk": "string (optional)"
}
```

**참고:**
- `skill_type`: "GLOBAL" (전역 스킬) 또는 "PROJECT" (프로젝트 종속 스킬)
...
### 수정
```
PATCH /projects/:prjNo/characters/:charNo/skills/:skillNo
Status: 200
```
...
### 삭제
```
DELETE /projects/:prjNo/characters/:charNo/skills/:skillNo
Status: 200
```
