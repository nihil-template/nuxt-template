...
### 목록 조회
```
GET /projects/:prjNo/items/:itemNo/skills
Status: 200
```
...
### 상세 조회
```
GET /projects/:prjNo/items/:itemNo/skills/:mapNo
Status: 200
```
...
### 생성
```
POST /projects/:prjNo/items/:itemNo/skills
Status: 200
```
...
### 수정
```
PATCH /projects/:prjNo/items/:itemNo/skills/:mapNo
Status: 200
```
...
### 삭제
```
DELETE /projects/:prjNo/items/:itemNo/skills/:mapNo
Status: 200
```
